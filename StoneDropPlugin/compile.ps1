...
$SrcDir = "c:/Users/g/Desktop/mc-server/plugins-source/StoneDropPlugin/src"
$BuildDir = "c:/Users/g/Desktop/mc-server/plugins-source/StoneDropPlugin/target"
