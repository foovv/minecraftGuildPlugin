...
$SrcDir = "c:/Users/g/Desktop/mc-server/plugins-source/CobbleXPlugin/src"
$BuildDir = "c:/Users/g/Desktop/mc-server/plugins-source/CobbleXPlugin/target"
